...
public class UnsafeShuffleWriter<K, V> extends ShuffleWriter<K, V> {
  ...
  private void open() {
    ...
    sorter = new ShuffleExternalSorter(
      ...
      blockManager,
      taskContext,
      initialSortBufferSize,  // 默认为4k
      partitioner.numPartitions(),
      sparkConf,
      writeMetrics);
    serBuffer = new MyByteArrayOutputStream(DEFAULT_INITIAL_SER_BUFFER_SIZE); //默认为1M
