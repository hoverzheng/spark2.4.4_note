...
public interface DeltaSqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DeltaSqlBaseParser#checkExprToken}.
	 * @param ctx the parse tree
	 */
	void enterCheckExprToken(DeltaSqlBaseParser.CheckExprTokenContext ctx);
	/**
	 * Exit a parse tree produced by {@link DeltaSqlBaseParser#checkExprToken}.
	 * @param ctx the parse tree
	 */
	void exitCheckExprToken(DeltaSqlBaseParser.CheckExprTokenContext ctx);
	/**
