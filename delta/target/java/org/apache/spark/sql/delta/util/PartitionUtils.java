...
public  class PartitionUtils {
  ...
  static public  class PartitionValues$ extends scala.runtime.AbstractFunction2<scala.collection.Seq<java.lang.String>, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Literal>, org.apache.spark.sql.delta.util.PartitionUtils.PartitionValues> implements scala.Serializable {
    /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Seq<org.apache.spark.sql.delta.util.PartitionUtils.PartitionValues> resolvePartitions (scala.collection.Seq<scala.Tuple2<org.apache.hadoop.fs.Path, org.apache.spark.sql.delta.util.PartitionUtils.PartitionValues>> pathsWithPartitionValues, boolean caseSensitive, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  static public  java.lang.String listConflictingPartitionColumns (scala.collection.Seq<scala.Tuple2<org.apache.hadoop.fs.Path, org.apache.spark.sql.delta.util.PartitionUtils.PartitionValues>> pathWithPartitionValues)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.catalyst.expressions.Literal inferPartitionColumnValue (java.lang.String raw, boolean typeInference, java.util.TimeZone timeZone, org.apache.spark.sql.delta.util.DateFormatter dateFormatter, org.apache.spark.sql.delta.util.TimestampFormatter timestampFormatter)  { throw new RuntimeException(); }
